...
export function InternalTransactionsTable({
  ...
  const [state, handleChangeFilterParams] = useTableFetch<IInternalTransactionsTableFetch>(
    fetchConfig,
  );
  ...
  return (
    <TableContent
      ...
      noElementsMessage={noElementsMessage || 'There are no internal transactions to show.'}
      displayTitleType={displayTitleType}
      type={isDesktop ? EPageType.internalTransactions : EPageType.internalTransactionsMobile}
      data={data}
      error={error}
      loading={loading}
      tableFetchConfig={{
