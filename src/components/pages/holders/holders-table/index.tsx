...
import { EHoldersSortAndFilterType, IHoldersTableFetch } from 'models/models-table-holders';
...
const DEFAULT_SORT_CONFIG = {
  ...
  sort: EHoldersSortAndFilterType.lastUpdated,
};
...
export function HoldersTable({
  ...
  const [state, handleChangeFilterParams] = useTableFetch<IHoldersTableFetch>(fetchConfig);
  ...
  return (
    <TableContent
      ...
      noElementsMessage={noElementsMessage || 'There are no holders to show.'}
      displayTitleType={displayTitleType}
      type={isDesktop ? EPageType.holders : EPageType.holdersMobile}
      data={data}
      error={error}
      loading={loading}
      tableFetchConfig={{
